...
2. o núcleo da versão anterior da TUI, que já possuía modelos de domínio, parsers e serviços voltados à instrumentação e à rede CAN/CAN FD.
...
- árvore de módulos CAN e sensores wireless;
- Probe 00 separada da topologia funcional;
...
- `SENSOR_DIRECT` e a conexão via Probe 00 alimentam os mesmos modelos.
...
- enquadramento definitivo entre Probe 00 e TUI;
