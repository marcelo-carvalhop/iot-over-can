...
def main() -> None:
    ...
    parser.add_argument("--port", "-p", default=None, help="Porta serial, por exemplo /dev/ttyACM0 ou COM5")
    ...
    parser.add_argument(
        "--security-config",
        default=None,
        help="Arquivo JSON opcional com otp_public_ids e unlock_seconds",
    )
